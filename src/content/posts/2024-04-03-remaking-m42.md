...
Cloudflare Workers 支持 Workers 非常简单，有兴趣的话可以看一下官网的教程：[https://developers.cloudflare.com/workers/examples/websockets/](https://developers.cloudflare.com/workers/examples/websockets/)  
