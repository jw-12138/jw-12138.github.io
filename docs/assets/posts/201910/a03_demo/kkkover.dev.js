;(function(w) {
    var kkkover = function () {
        ...
        this.init = function (obj) {
            ...
            if(!obj.wrapCell){
                throw 'kkkover.js: Give me an <wrapCell> object! You can see docs at https://jw1.dev/kkkover.js';
            }
            if(!obj.img){
                throw 'kkkover.js: Give me an <img> object! You can see docs at https://jw1.dev/kkkover.js';
            }
            w.onresize = function () {
                _.resized(obj);
            }
